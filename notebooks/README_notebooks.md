...
This directory contains curated Jupyter notebooks demonstrating **VQE**, **ADAPT-VQE**, **LR-VQE**, **QSE/VQD/SSVQE** (excited states), **QPE**, and **VarQITE** workflows using the packaged code in:
